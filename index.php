        ...
        <section class="hero">
            <div class="container">
                ...
                <div class="hero-image" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                    <img src="cover.png" alt="EduNomo AI Görseli">
                </div>
            </div>
        </section>
                ...
                <div class="assistant-container" data-aos="fade-up">
                     <div class="assistant-card">
                        <div class="assistant-avatar">
                            <img src="man.png" alt="EduNomo Asistan" id="assistant-image">
                    ...
                    <div id="loading" class="loading-container" style="display: none;">
                        <div class="loading-content">
                            <div class="assistant-thinking">
                                <img src="man.png" alt="Asistan Çalışıyor" id="loading-character">
                ...
                <div class="contact-container">
                    ...
                    <div class="contact-form" data-aos="fade-left" data-aos-delay="200">
                        <form id="feedback-form">
                            <div class="form-group"><label for="name">İsim</label><input type="text" id="name" name="name" placeholder="Adınız" required></div>
                            <div class="form-group"><label for="email">E-posta</label><input type="email" id="email" name="email" placeholder="E-posta adresiniz" required></div>
                            <div class="form-group"><label for="message">Mesaj</label><textarea id="message" name="message" rows="4" placeholder="Mesajınız" required></textarea></div>
                            <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-paper-plane"></i> Gönder</button>
                        </form>
                    </div>
                </div>
            </div>
